analyze -sva +define+CONTRACT=0 ./src/boom/two_copy_top.sv ./src/boom/TestHarness.v ./src/boom/SmallBoom.v ./src/boom/BOOM_mem.v ./src/boom/plusarg_reader.v ./src/boom/ClockDividerN.sv ./src/boom/EICG_wrapper.v ./src/boom/IOCell.v ./src/boom/SimDRAM.v ./src/boom/SimJTAG.v ./src/boom/SimSerial.v ./src/boom/SimUART.v 
...
# Make sure the tag array is fixed to a legal memory range
...
save -jdb my_jdb_sandbox_2copy_boom -capture_setup -capture_session_data
